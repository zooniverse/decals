...
subject_loc = f'{catalog_dir}/decals_dr1_and_dr2.csv'
# previous_subjects_loc = '/data/galaxy_zoo/decals/subjects/galaxy_zoo_subjects.csv'  # DR1 and DR2 subjects - is this actually used?
